...
// servlet-context.xml에서 <context:component-scan base-package="org.zerock.controller" />
@Controller
...
public class SampleController {
	...
	public void basic() {
		...
		log.info("현재 /WEB-INF/views/basic.jsp가 없으므로 크롬에는 오류가 납니다.");
	...
	public void basicGet() {
		...
		log.info("get방식 post방식 둘 다 반응한다...");
	} // basicGet메서드 종료
	...
	public String ex02(@RequestParam("owner")String name, @RequestParam("age") int age) {
		// 프론트 변수와 백엔드의 변수가 다를 때 !!! (초보자는 일치시킬 것!)
		log.info("name: " + name);
		log.info("age : " + age);
	...
	public String ex04(SampleDTO dto, @ModelAttribute("page") int page) { // int page는 게시판의 페이징기법 예시
		// @ModelAttribute("page") 안 쓰면 백엔드에는 전달이 되지만 프론트에는 전달이 안됨
	...
	public void ex05() {
		...
		// 리턴이 void인 경우에는 자동으로 [/WEB0INF/views/sample/ex05.jsp]를 찾는다.
		// 초보자 사용 금지!!!
