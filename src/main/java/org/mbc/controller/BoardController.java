...
public class BoardController {
	...
	public void list(Model model) {
		...
		// 프론트에서 ${list} 로 활용한다. (for문을 사용해야 할 것 같다.)
	}
	...
	public String register(BoardVO board, RedirectAttributes rttr) {
		...
		log.info("BoardController.register메서드가 실행.......");
	...
	public void get(@RequestParam("bno") Long bno, Model model) {
		...
		log.info("BoardController.get메서드가 실행.......");
	...
	public String modify(BoardVO board, RedirectAttributes rttr) {
		...
		log.info("BoardController.modify메서드가 실행.......");
	...
	public String remove(@RequestParam("bno") Long bno, RedirectAttributes rttr) {
		// 프론트에서 삭제할 번호가 넘어오면 delete 쿼리가 실행되고 결과가 boolean 으로 나옴
		log.info("BoardController.remove메서드가 실행.......");
